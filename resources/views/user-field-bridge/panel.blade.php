                                                ...
                                                <div x-show="open" x-cloak class="jd-sfpf-field-body">
                                                    <div class="jd-sfpf-field-row">
                                                        <div class="jd-sfpf-side jd-sfpf-side-notion">
                                                            ...
                                                            <textarea x-model="fieldRow.notion_value" @input="markBridgeFieldDirty(fieldRow, `notion`); resizeBridgeTextArea($event.target)" x-init="$nextTick(() => resizeBridgeTextArea($el))" x-effect="fieldRow.notion_value; $nextTick(() => resizeBridgeTextArea($el))" class="jd-sfpf-input" rows="1" :style="fieldInputStyle(fieldRow, `notion`)" :readonly="!{!! $linkExpr !!}.manual_open"></textarea>
                                                        ...
                                                        <div class="jd-sfpf-side jd-sfpf-side-wp">
                                                            ...
                                                            <textarea x-model="fieldRow.wp_value" @input="markBridgeFieldDirty(fieldRow, `wordpress`); resizeBridgeTextArea($event.target)" x-init="$nextTick(() => resizeBridgeTextArea($el))" x-effect="fieldRow.wp_value; $nextTick(() => resizeBridgeTextArea($el))" class="jd-sfpf-input" rows="1" :style="fieldInputStyle(fieldRow, `wordpress`)" :readonly="!{!! $linkExpr !!}.manual_open"></textarea>
